                    ...
                    <div id="conditional_sales" is="dmx-if" dmx-bind:condition="((visible_career.value == 'career_sales')||(visible_career.value == 'career_all'))">
                        <section id="career_sales">
                            ...
                            <div class="row border-1 border-secondary border-bottom pt-4 pb-4 visually-hidden">
                                ...
                                <div class="col-lg-2 text-end">
                                    <button id="apply_now2" class="btn btn-link text-decoration-none btn-lg text-warning pt-0 pb-0 ps-0 pe-0" wappler-command="editContent" dmx-on:click="browser1.goto('https://forms.clickup.com/14351633/f/dnz8h-3007/TLP7SME0J1UKEEPGY')">Apply Now&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i></button>
                                </div>
                            </div>
                            <div class="row border-1 border-secondary border-bottom pt-4 pb-4 visually-hidden">
                                <div class="col-lg-10 mb-2">
