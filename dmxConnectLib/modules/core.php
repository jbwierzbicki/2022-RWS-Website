...
class core extends Module
{
    ...
    public function select($options) {
        ...
        if (is_array($options->cases)) {
            ...
            foreach ($options->cases as $case) {
                if ($this->compareValues($expression, $case->value)) {
    ...
    private function compareValues($a, $b) {
        // Handle numeric comparisons - only for actual int/float types
        ...
        // Default to strict comparison for all other types (including numeric strings)
        return $a === $b;
    }
