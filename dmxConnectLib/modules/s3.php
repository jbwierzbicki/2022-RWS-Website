...
class s3 extends Module
{
    ...
    public function createFolder($options) {
        option_require($options, 'provider');
        option_require($options, 'bucket');
    ...
    public function copyFile($options) {
        option_require($options, 'provider');
        option_require($options, 'srcBucket');
        option_require($options, 'srcKey');
        option_require($options, 'dstBucket');
        option_require($options, 'dstKey');

        $options = $this->app->parseObject($options);

        $s3 = $this->getClient($options->provider);

        return $s3->copyObject(array(
