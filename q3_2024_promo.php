    ...
    <section id="modules" class="border-top rounded-1 rounded-0 min-vh-75 border-secondary pb-3" style="min-height: 75vh;">
        ...
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="progress-info">
                                ...
                                <h6>
                                    <span id="donationAmount" class="fw-bold">$100</span> donated to Rainbow Children's Hospital so far!
                                </h6>
                                <p>
                                    Help us reach up to $1,000 by posting your pic and tagging us. Thank you for your support!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-around mb-5 pt-4">
                ...
                <div class="col-lg-5">
                    <img src="assets/images/rainbow_q3_2024_promo-1.webp" class="img-fluid w-100 mb-2 rounded">
                </div>
                <div class="text-start col-lg-7">
                    ...
                    <a><button class="btn module-cta-btn lh-lg text-truncate ps-3 pe-3 btn-outline-warning" dmx-on:click="browser1.goto('https://www.uhhospitals.org/rainbow/about/uh-rainbow-foundation')">Learn More</button></a>
                </div>
            </div>
