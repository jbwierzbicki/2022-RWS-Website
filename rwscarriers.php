                    ...
                    <form id="carrierform" is="dmx-form" novalidate="">
                        <div class="row">
                            <div class="text-left col-12">
                                ...
                                <a target="_blank" rel="noopener noreferrer" is="dmx-link" data-lf-fd-inspected-kn9eq4r1yyr7rlvp="true">
                                    <button id="btn1" class="btn btn-secondary pl-3 pr-3 mb-4 pt-3 pb-3 ps-3 pe-3" is="dmx-button" value="" type="button" dmx-on:click="browser1.goto('assets/Raging%20Wolf%20Carrier%20Packet%2011-12-24.pdf')"><i class="fa fa-download"></i>&nbsp;Download Carrier Packet</button>
                                </a>
