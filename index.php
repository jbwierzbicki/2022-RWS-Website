...
-->
    ...
    fbq('init', '283523041006801');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=283523041006801&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>
...
<body is="dmx-app" id="index" class="bg-dark">
    ...
    <main class="index-main" is="dmx-background-video" id="bgvideo1" src="Website%20Header%20Version%20Raging%20Wolf%20Musicvideo.mp4" dmx-style="top:70%;left:0%;">
