                ...
                <div class="row h-100">
                    <div class="module-card col border rounded-0 rounded-1 border-secondary mt-3 mb-3 ms-3 me-3 pt-3 pb-3 ps-3 pe-3">
                        <div class="d-flex flex-wrap align-content-between h-100">
                            ...
                            </div><a href="referral.php"><button id="Learn_More" class="btn text-warning ps-0 pe-0 module-cta-btn text-start" data-bs-target="undefined">Get Recognized&nbsp;&nbsp;<i class="fas fa-caret-right"></i></button></a>
                        </div>
                ...
                <div class="container text-bg-dark h-25">
                    <div class="row justify-content-center align-items-center bg-dark">
                        <div class="swiper-container module-card col border rounded-0 rounded-1 border-secondary mt-3 mb-3 ms-3 me-3 pt-2 align-self-center" id="swipeHome">
                            <div is="dmx-swiper" class="swiper-wrapper" id="swiper1" centered-slides="true" grab-cursor="true" loop="true" speed="600" space-between="150" navigation="true" style="--swiper-navigation-color: #c7c5c5;" autoplay="true">
                ...
                <div class="row">
                    <div class="module-card col border rounded-0 rounded-1 border-secondary mt-3 mb-3 ms-3 me-3 pt-3 pb-3 ps-3 pe-3">
                        <div class="row justify-content-center">
                            <div class="pl-1 pr-1 col-12 col-md-9 text-center">

                                <h4 class="text-light text-left mt-2 mb-3">Raging Wolf Solutions Promotional Offers</h4>
                                <p class="text-white-50 lh-base fw-normal mb-3">If you like to keep in the "know," you have come the right place. Whether it is to find a shipping solution, give back to the comunity or try your luck you will find the details here!</p>
