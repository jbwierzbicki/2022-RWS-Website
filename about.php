                    ...
                    <form id="carrierform" is="dmx-form" novalidate="">
                        <div class="row mt-4">
                            <div class="col-lg-3 mb-3">
                                ...
                                <div class="d-flex border border-secondary rounded bg-transparent mb-3 pt-2 pb-2 ps-2 pe-2">
                                    <h4 class="mb-0 text-secondary">History</h4>
                                </div>
                                <div class="d-flex border border-secondary rounded mb-2 pt-2 pb-2 ps-2 pe-2 bg-transparent">
                                    <h4 class="mb-0 text-secondary">Media</h4>
                                </div>
                            </div>
