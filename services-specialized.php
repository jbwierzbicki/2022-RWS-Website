...
<head>
    ...
    <meta charset="UTF-8">
    <title>Freight Logistics: Specialized Services | Raging Wolf Solutions</title>
...
<body is="dmx-app" id="index" class="bg-dark">
    ...
    <main class="index-main services-main" id="servicesmaincustomizedservices">
                ...
                <div class="col">
                    <div class="row justify-content-center gx-5">
                        <div class="text-sm-left text-left text-md-center services--main--section--container--row--col col-md-auto col-12 pt-3">
                            <img src="assets/images/services-customized-services-icon.webp" class="services--main--section--container--row--col--img rounded-circle mb-3">
                        </div>
                        <div class="services--main--section--container--row--col2 col-auto col-12 pt-3 pb-3 col-md-5">
                            ...
                            <h1 class="mt-0 fw-bold text-white">Specialized Services</h1>
                            <h5 class="mt-0 fw-bold text-light">The 'PACK' tailors a specific portfolio of customized solutions to meet your company's individual shipping/transportation needs.</h5>
                            <h5 class="services--main--section--container--row--col2-h5 text-light mb-4"><i class="fas fa-angle-right"></i>&ensp;Less Than Truckload (LTL)<br>
                                <i class="fas fa-angle-right"></i>&ensp;Trade Shows / Exhibits<br>
                                <i class="fas fa-angle-right"></i>&ensp;White Glove<br>
                                <i class="fas fa-angle-right"></i>&ensp;Air Charters
                            </h5>
